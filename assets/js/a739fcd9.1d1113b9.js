		...
		1375: (e, t, r) => {
			...
			var n = r(7462),
				...
				p = {
					...
					source: "@site/blog/2020-06-10-swc-1.1.56.md",
					title: "Changelog: swc v1.1.56",
				...
				u = [
					{
						...
						children: [
							{
								value: "Inline sourcemap (#832)",
								id: "inline-sourcemap-832",
								children: [],
							},
						],
					},
				...
				return (0, a.kt)(
					...
					(0, a.kt)(
						...
						(0, a.kt)(
							...
							{
								parentName: "h3",
								href: "https://github.com/swc-project/swc/pull/832",
							},
							"#832",
						),
						")",
					...
					(0, a.kt)(
						...
						" handled inlined source maps wrongly. Starting with ",
						(0, a.kt)(
							"inlineCode",
							{ parentName: "p" },
							"swc@1.1.56",
						),
						", inline source maps are handled properly.",
					),
				);
			}
			f.isMDXComponent = !0;
