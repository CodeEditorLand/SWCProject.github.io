			...
			var l = n.createContext({}),
				...
				f = n.forwardRef(function (e, t) {
					var r = e.components,
						...
						f = p(r),
						m = o,
						d = f["".concat(l, ".").concat(m)] || f[m] || u[m] || a;
					return r
						? n.createElement(
								d,
		...
		6659: (e, t, r) => {
			...
			var n = r(7462),
				...
				p = {
					...
					source: "@site/blog/2020-09-24-swc-1.2.34.md",
					title: "Hotfix: swc v1.2.34",
				...
				s = [
					{
						...
						children: [
							{
								value: "jest extension (#1106)",
								id: "jest-extension-1106",
								children: [],
							},
						],
					},
				...
				return (0, a.kt)(
					...
					(0, a.kt)(
						...
						(0, a.kt)(
							...
							{
								parentName: "h3",
								href: "https://github.com/swc-project/swc/pull/1106",
							},
							"#1106",
						),
						")",
					...
					(0, a.kt)(
						...
						" errornously removed some useful statemetns.",
					),
				);
			}
			f.isMDXComponent = !0;
