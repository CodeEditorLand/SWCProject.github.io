		...
		610: (e, t, r) => {
			...
			var n = r(7462),
				...
				p = {
					...
					source: "@site/blog/2019-12-25-swc-1.1.9.md",
					title: "Changelog: swc v1.1.9",
					description: "Legacy decorator (#421)",
				...
				u = [
					{
						value: "Legacy decorator (#421)",
						id: "legacy-decorator-421",
						children: [],
					},
				],
				s = { toc: u };
			function f(e) {
				...
				return (0, a.kt)(
					...
					(0, a.kt)(
						"p",
						null,
						"Also, you can use it from ecmascript too. If you want it, you should set ",
						(0, a.kt)(
							"inlineCode",
							{ parentName: "p" },
