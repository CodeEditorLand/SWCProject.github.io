			...
			var l = n.createContext({}),
				...
				f = n.forwardRef(function (e, t) {
					var r = e.components,
						...
						f = p(r),
						d = o,
						m = f["".concat(l, ".").concat(d)] || f[d] || u[d] || a;
					return r
						? n.createElement(
								m,
		...
		8872: (e, t, r) => {
			...
			var n = r(7462),
				...
				p = {
					...
					source: "@site/blog/2020-06-06-swc-1.1.54.md",
					title: "Changelog: swc v1.1.54",
					description: "Bugfixes",
					date: "2020-06-06T00:00:00.000Z",
					formattedDate: "June 6, 2020",
					tags: [],
					readingTime: 0.365,
					truncated: !1,
					prevItem: {
				...
				s = [
					{
						...
						children: [
							{
								value: "Usage of static property in decorators (#824)",
								id: "usage-of-static-property-in-decorators-824",
								children: [],
							},
						],
					},
			...
			function f(e) {
				...
				return (0, a.kt)(
					...
					(0, a.kt)(
						"h3",
						{ id: "usage-of-static-property-in-decorators-824" },
						"Usage of static property in decorators (",
						(0, a.kt)(
							"a",
							{
								parentName: "h3",
								href: "https://github.com/swc-project/swc/pull/824",
							},
							"#824",
						),
						")",
					...
					(0, a.kt)(
						"p",
						null,
						"Previously, the code above throws an error if it's compiled with ",
						(0, a.kt)("inlineCode", { parentName: "p" }, "swc"),
						" and works if it's compiled with ",
						(0, a.kt)("inlineCode", { parentName: "p" }, "tsc"),
						".\nThe bug is now fixed, and ",
						(0, a.kt)("inlineCode", { parentName: "p" }, "swc"),
