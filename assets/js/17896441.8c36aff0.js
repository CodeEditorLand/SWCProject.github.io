...
(self.webpackChunk = self.webpackChunk || []).push([
	[7918],
	{
		8070: (e, t, a) => {
			...
			function m(e) {
				var t = d[e.versionMetadata.banner];
			...
			function v(e) {
				var t,
					a = e.versionMetadata,
					r = (0, s.Z)().siteConfig.title,
					l = (0, o.gA)({ failfast: !0 }).pluginId,
					i = (0, c.J)(l).savePreferredVersionName,
					d = (0, o.Jo)(l),
					v = d.latestDocSuggestion,
					h = d.latestVersionSuggestion,
					E =
						null != v
							? v
							: (t = h).docs.find(function (e) {
			...
			const h = function (e) {
				...
				return "none" === t.banner
					? n.createElement(n.Fragment, null)
					: n.createElement(v, { versionMetadata: t });
			};
			var E = a(1217);
			function p(e) {
							...
							values: {
								atDate:
									t && a
										...
										: "",
								byUser: r
									? n.createElement(g, { lastUpdatedBy: r })
									: "",
							},
						},
			...
			const T = function (e) {
				var t,
					...
					d = s.keywords,
					m = s.hide_title,
					u = s.hide_table_of_contents,
					v = l.description,
					p = l.title,
					g = l.editUrl,
					T = l.lastUpdatedAt,
					y = l.formattedLastUpdatedAt,
					w = l.lastUpdatedBy,
					A = (0, o.gA)({ failfast: !0 }).pluginId,
					C = (0, o.gB)(A).length > 1,
					B = !m && void 0 === a.contentTitle;
				return n.createElement(
					n.Fragment,
					null,
					n.createElement(E.Z, {
					...
					n.createElement(
						...
						n.createElement(
							...
							n.createElement(h, { versionMetadata: r }),
							n.createElement(
								"div",
								{ className: Z },
								n.createElement(
		...
		571: (e, t, a) => {
			...
			const c = function (e) {
				var t = e.toc;
				return (
					l(s, "table-of-contents__link--active", 100),
					n.createElement(
						"div",
