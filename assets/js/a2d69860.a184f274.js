	...
	[6427],
	{
		3905: (t, e, a) => {
			...
			var m = r.createContext({}),
				o = function (t) {
					var e = r.useContext(m),
						a = e;
					return (
						t &&
							(a =
								"function" == typeof t ? t(e) : p(p({}, e), t)),
						a
					);
				},
				d = function (t) {
				...
				g = r.forwardRef(function (t, e) {
					var a = t.components,
						...
						g = o(a),
						k = n,
						N = g["".concat(m, ".").concat(k)] || g[k] || b[k] || l;
					return a
						? r.createElement(
								N,
								p(p({ ref: e }, d), {}, { components: a }),
							)
						: r.createElement(N, p({ ref: e }, d));
				});
			function k(t, e) {
				var a = arguments,
					n = e && e.mdxType;
				if ("string" == typeof t || n) {
					...
					p[0] = g;
					var i = {};
					for (var m in e) hasOwnProperty.call(e, m) && (i[m] = e[m]);
					(i.originalType = t),
						(i.mdxType = "string" == typeof t ? t : n),
						(p[1] = i);
					for (var o = 2; o < l; o++) p[o] = a[o];
		...
		438: (t, e, a) => {
			...
			function g(t) {
				...
				return (0, l.kt)(
					"wrapper",
					(0, r.Z)({}, b, a, { components: e, mdxType: "MDXLayout" }),
					(0, l.kt)(
						"p",
						null,
						"Note: For the case where this document is outdated, you can expect swc to support all of ecmascript specifcation.",
